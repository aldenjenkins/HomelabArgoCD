...
AWS_S3_ENDPOINT_URL = 'http://192.168.123.170:9000'

STORAGES = {
    "default": {
        "BACKEND": "storages.backends.s3.S3Storage",
        "OPTIONS": {
            "access_key": os.getenv("NAUTOBOT_S3_ACCESS_KEY_ID"),
            "secret_key": os.getenv("NAUTOBOT_S3_SECRET_ACCESS_KEY"),
            "bucket_name": "nautobot",
